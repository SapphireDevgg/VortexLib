...
A modified version of VortexLib
github.com/discoart/VortexLibPlus | dsc.gg/hydrahub
...
local SaveManager = {} do
	SaveManager.Folder = "VortexLibSettings"
	SaveManager.Ignore = {}
	SaveManager.Parser = {
		Toggle = {
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "VortexLibSettings"
