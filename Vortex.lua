...
A modified version of VortexUi
github.com/discoart/VortexUiPlus | dsc.gg/hydrahub
			...
			if not RunService:IsStudio() and Mobile and Minimizer then
				pcall(function()
					...
					if minimizeButton then
						...
						if imageLabel then
							imageLabel.Image = Window.Minimized and "rbxassetid://87290457744276" or "rbxassetid://87290457744276"
						end
					end
				end)
			end
...
local Icons = {
	...
	["lucide-moon"] = "rbxassetid://93647888056248",
...
local SaveManager = {} do
	SaveManager.Folder = "VortexUiSettings"
	SaveManager.Ignore = {}
	SaveManager.Parser = {
		Toggle = {
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "VortexUiSettings"
