    ...
    function self:create_tab(title: string, icon: string)
        ...
        function TabManager:create_module(settings: any)
            ...
            if not settings.rich then
                ModuleName.Text = settings.title or "VortexHub-2"
            else
            ...
            function ModuleManager:create_paragraph(settings: any)
                ...
                if not settings.rich then
                    Body.Text = settings.text or "VortexHub-1"
                else
                    Body.RichText = true
            ...
            function ModuleManager:create_text(settings: any)
                ...
                if not settings.rich then
                    Body.Text = settings.text or "VortexHub-1" -- Default text
                else
                    Body.RichText = true
                ...
                function TextManager:Set(new_settings)
                    if not new_settings.rich then
                        Body.Text = new_settings.text or "VortexHub-1" -- Default text
                    else
                        Body.RichText = true
...
--[[ RAINBOW TOGGLE BUTTON INJECTED ]]--

-- Toggle Button
local toggleGui = Instance.new("ScreenGui")
toggleGui.Name = "ControlGUI"
